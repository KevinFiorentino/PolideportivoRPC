...
<!-- Fin Barra de Navegacion -->
	...
	<body>
		...
		<h3> Consultar canchas por deporte </h3>
		<br>
		<form action="clienteCanchaDeporte.php" method="POST" class="form-inline">
		 <label>Deporte : &nbsp;</label>
			<input type="text" class="form-control" name="deporte" value="">
