<?php
	...
	try {
		...
		$resultado = $client->traerTurnoPorId($idTurno);
?>
...
<!-- Fin Barra de Navegacion -->
	...
	<body>
		...
		<?php
			echo "<h1> Datos de turno Nº: $idTurno </h1> <br/>";
			?>
			<table class="table"> <?php
			echo "<thead>";
			echo "<tr><th>idTurno</th><th>FechaHora</th><th>Vigente</th><th>idFilial</th><th>deporte</th><th>idCancha</th><th>idUsuario</th></tr>";
			echo "</thead><tbody>";
				
				echo "<tr>";
				echo "<td>" . $resultado->idTurno . "</td>";
				echo "<td>" . $resultado->fechaHora . "</td>";
				echo "<td>" . $resultado->vigente . "</td>";
				echo "<td>" . $resultado->localidad . "</td>";
				echo "<td>" . $resultado->deporte . "</td>";
				echo "<td>" . $resultado->tipoCancha . "</td>";
