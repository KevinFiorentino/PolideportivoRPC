...
<!-- Fin Barra de Navegacion -->
	...
	<body>
		...
		<h3> Consultar turno por idFilial </h3>
		<br>
		<form action="cliente.php" method="POST" class="form-inline">
		 <label>Identidad Filial : &nbsp;</label>
			<input type="number" class="form-control" name="idFilial" value="">
