...
<!-- Fin Barra de Navegacion -->
	...
	<body>
		...
		<h3> Consultar cancha por Identidad </h3>
		<br>
		<form action="clienteCanchaId.php" method="POST" class="form-inline">
			<label>Identidad Cancha : &nbsp; </label><input type="number" class="form-control" name="idCancha" value=""/>
