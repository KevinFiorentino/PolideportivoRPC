...
<!-- Fin Barra de Navegacion -->
	...
	<body>
		...
		<?php
			try {
				$resultado = $client->traerTelefonoPorUsuario($nombre,$apellido);
				echo "<h1> Telefono de $nombre $apellido : </h1> <br/>"; ?>
<div class="alert alert-info" role="alert"> <?php echo " $resultado " ?> </div> <?php				
				}
			catch (\Poli\NoEncontrado $e) {
				?> <div class="alert alert-danger" role="alert"> <?php echo " $e->dato" ?> </div> <?php
				}
		} catch (TException $tx) {
