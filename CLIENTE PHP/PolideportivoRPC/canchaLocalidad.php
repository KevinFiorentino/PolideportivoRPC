...
<!-- Fin Barra de Navegacion -->
	...
	<body>
		...
		<h3> Consultar localidad de una Filial </h3>
		<h6> Incluye Excepcion CampoVacio </h6>
		<br>
		<form action="clienteCanchaLocalidad.php" method="POST" class="form-inline">
			<label>Identidad Filial: &nbsp;</label><input type="text" class="form-control" name="idFilial" value=""/>
