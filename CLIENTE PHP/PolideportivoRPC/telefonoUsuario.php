...
<!-- Fin Barra de Navegacion -->
	...
	<body>
		...
		<h3> Consultar telefono por Nombre y Apellido </h3>
		<h6> Incluye Excepcion NoEncontrado </h6>
		<br>
		<form action="clienteTelefono.php" method="POST" class="form-inline">
			<label>Nombre : &nbsp;</label><input type="text" class="form-control" name="nombre" value=""/>
			<label>&nbsp; Apellido : &nbsp;</label><input type="text" class="form-control" name="apellido" value=""/>
