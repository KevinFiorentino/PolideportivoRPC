<?php
	...
	try {
		...
		$resultado = $client->traerTurnosPorFilial($idFilial);
?>
...
<!-- Fin Barra de Navegacion -->
	...
	<body>
		...
		<?php
			echo "<h1> Turnos de Filial Nº: $idFilial </h1> <br/>"; ?>
			<table class="table"> <?php
			echo "<thead>";
			echo "<tr><th>idTurno</th><th>Fecha y Hora</th><th>Vigente</th><th>Localidad</th><th>Deporte</th><th>Tipo Cancha</th><th>Usuario</th></tr>";
			echo "</thead><tbody>";
			...
			foreach ($resultado as $turno){
				...
				echo "<td>" . $turno->vigente . "</td>";
				echo "<td>" . $turno->localidad . "</td>";
				echo "<td>" . $turno->deporte . "</td>";
				echo "<td>" . $turno->tipoCancha . "</td>";
